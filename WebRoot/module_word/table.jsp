	...
	<div class="formbody">
		...
		<ul class="forminfo" style="display: none;" id="forminfo">
			<li><label>关键字</label> <input name="" type="text"
				class="dfinput" id="rt" /> <i>关键字不能超过10个字符</i></li>
			<li><label>&nbsp;</label> <input name="" onclick="insert()"
	...
	<div class="rightinfo">
		<div class="tools">
			<ul class="toolbar">
				...
				<li class="click" onclick="toUpdate()"><span><img
						src="images/t02.png" /></span>修改</li>
				<li onclick="delete_guann()"><span><img
