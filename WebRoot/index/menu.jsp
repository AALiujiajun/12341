...
<dl class="leftmenu">
	...
	<dd>
		...
		<ul class="menuson">
			...
			<li><cite></cite><a href="selectt">查看信息</a><i></i></li>
		</ul>    
	</dd>
	<!-- 一个模块结束 -->
		<!-- 一个模块开始 -->
	<dd>
		...
		<ul class="menuson">
			<li><cite></cite><a href="module_center/showup.jsp">个人信息修改</a><i></i></li>
			<li><cite></cite><a href="module_center/changepsw.jsp">修改密码</a><i></i></li>
		</ul>    
	</dd>
	<!-- 一个模块结束 -->
	<!-- 一个模块开始 -->
	<dd>
		<div class="title">
			<span><img src="<%=basePath %>images/leftico01.png"/></span>用户管理中心
		</div>
		<ul class="menuson">
			<li><cite></cite><a href="user_select">用户信息管理</a><i></i></li>
			<li><cite></cite><a href="zhuxuechao">用户分布</a><i></i></li>
		</ul>    
	</dd>
	<!-- 一个模块结束 -->
		<!-- 一个模块开始 -->
	<dd>
		...
		<ul class="menuson">
			<li><cite></cite><a href="module_word/table.jsp">关键字查询</a><i></i></li>
		</ul>    
	</dd>
	<!-- 一个模块结束 -->
