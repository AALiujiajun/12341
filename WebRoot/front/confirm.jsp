...
<body>
    ...
    <div class="fonfirm">
        ...
        <table class="fonfirm_table">
            ...
            <tr>
                <td>1</td>
                <td><img src="idleimg/${mapp.idleimg }">${mapp.name }</td>
                <td>￥${mapp.transfer_price }</td>
                <td>${mapp.amount}</td>
                <td>￥${mapp.transfer_price*mapp.amount}</td>
            </tr>
        ...
        <form  name="alipayment" action="alipay.trade.page.pay.jsp" method="post">
	        <div class="clearfix">
	            <ul class="confirm_q">
	                <li class="confirm_q_f">实付款：<span>￥</span><i>${mapp.transfer_price*mapp.amount }</i></li>
	                <li>寄送至：
	                	<span>
			                <input type="text" name="address" />
			                <input type="hidden" name="WIDtotal_amount" value="${mapp.transfer_price*mapp.amount }"/>
			                ...
			                <input type="hidden" name="u_idle_id" value="${mapp.id}"/>
	                	</span>
	                </li>
