...
<body>
    ...
    <!-- 注册 -->
    <div class="register">
        <form id="bdyz" action="reg_front" method="post">
            <div class="tel clearfix">
                <span>密码</span>
                <input type="text" id="psw1">
                <i id="txt2"></i>
            </div>
            <div class="tel clearfix">
                <span>确认密码</span>
                <input type="text" name="psw" id="psw2" onblur="checksamepsw()">
            </div>
            <div class="tel clearfix">
                <span></span>
                <input type="submit" disabled="disabled" id="bt" value="注册" class="sub">
            </div>
        </form>
        <script>
