    ...
    <div class="xiangqing wrap clearfix">
        <div class="fl">
            <div class="xiangqing_img">
                <img width='546px' height='728px' src="idleimg/${mapp.idleimg}">
            </div>
                <ul class="bbjs">
                    <li>宝贝介绍</li>
                </ul>
        ...
        <div class="xiangqing_right fr">
            <h1 class="xiangqing_title">${mapp.name}</h1>
            <ul class="price">
                <li class="price_first">转  卖  价：<span>¥</span><i>${mapp.transfer_price}</i></li>
                <li>成　　色：${mapp.percentage}</li>
                <li>所  在  地：${mapp.location}</li>
               
            </ul>
            <a href="front/confirm.jsp" target="_blank" class="xingqing_buy">立即购买</a>
            <div class="danbao">
