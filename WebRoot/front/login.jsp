...
<body>
	...
	<div class="login_main">
		<div class="wrap">
			<form action="login_front" method="post" class="list">
				<div class="login_title">密码登录</div>
				<input  name="username_front" type="text" class="name" placeholder="手机号">
				<input name="pwd_front" type="password" class="password">
