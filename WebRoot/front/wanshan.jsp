...
<body>
    ...
    <!-- 宝贝信息 -->
    <form action="wanshan_front" method="post" enctype="multipart/form-data">
    <div class="bbxx wrap">
    	<div class="biaodan"><span>用户账号：</span><input type="text" name="front_namee" readonly="readonly"  value="${map_front.u_account}"></div>
    	<div class="biaodan"><span>用户昵称：</span><input type="text" name="front_nicknamee"></div>
    	<div class="biaodan"><span>省：</span><input type="text" name="front_provincee"></div>
    	<div class="biaodan"><span>市：</span><input type="text" name="front_cityy"></div>
    	<div class="biaodan"><span>区：</span><input type="text" name="front_districtt"></div>
    	<div class="tutu"><span>用户头像路径：</span><input name="idleimg"  type="file" id="xdaTanFileImg" onchange="xmTanUploadImg(this)" accept="image/*"/></div>
